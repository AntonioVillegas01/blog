...
<head>
    ...
    <title>Desilog | Blog and File Resource HTML Theme </title>
...
<div class="top-banner">
    <a href=""><img src="images/top-banner.png" alt="Top Banner Advertisements"></a>
</div>
...
<div class="container">
    <div class="logo-search header-two clearfix">
        <div class="logo">
            <h1>
                <a href="index-2.html"><img src="http://themecss.com/wp/Desilog/wp-content/themes/desilog/img/logo.png" alt="Desilog" title="Desilog">
                </a>
            </h1>
        </div>
        ...
        <div class="ticker-flexslider">
            <div class="flex-viewport">
                <ul class="slides">
                    <li class="clone">
                        <img src="images/super-natural-43x39.jpg" alt="science-kombat">
                        <div class="ticker-action">
                            <span>Feb 18, 2017</span>
                            <h4><a href="blog-details.html">Science Kombat</a></h4>
                        </div>
                    </li>
                    <li class="clone">
                        <img src="images/theater-hannover-43x39.jpg" alt="science-kombat">
                        <div class="ticker-action">
                    ...
                    <li class="clone">
                        <img src="images/skills-radar-43x39.jpg" alt="science-kombat">
                        <div class="ticker-action">
                ...
                <div class="sidebar theiaStickySidebar">
                    <div class="widget widget_text">
                        ...
                        <div class="textwidget">
                            <a href=""><img src="images/ads_one.jpg" alt="Sidebar Banner Advertisements" class="img-responsive"></a>
                        </div>
                    </div>
...
<footer>
    <div class="container">
            ...
            <div class="row">
                <div class="col-sm-4">
                    <div class="">
                        <div class="widget widget_text">
                            <div class="textwidget">
                                <a href="index-2.html"><img src="images/footer-logo.png" alt="Desilog"></a>
        ...
        <div class="clearfix">
            <label class="copyright">&copy;&nbsp;2017&nbsp;<a href="">Desilog</a>&nbsp;‐&nbsp;All Rights Reserved</label>
